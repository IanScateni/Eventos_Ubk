		...
		<tbody>
			<?php while ($service = $services->fetch_object()):?>
				<tr>
					...
					<td><img class="img-fluid eventImg" src="../../public/img/<?= $service->cover ?>" alt=""></td>
					<td><span class="btn btn-warning btn-sm" data-bs-toggle="modal" data-bs-target="#editService" onclick="updateService('<?= $service->id ?>')" ><span class="fas fa-edit"></span></span></td>
